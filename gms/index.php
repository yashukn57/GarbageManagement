...
<head>
    <meta charset="utf-8">
    <title> Location Based Garbage Management System || Home Page</title>
...
{               ?>      
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"> Location Based Garbage Management System</h2>
        </a>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome To Location Based Garbage Management System</h5>
                                <h1 class="display-3 text-white animated slideInDown mb-4">Best Location Based Garbage Management Services</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Transforming Waste into Resources for a Greener Tomorrow.</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#"> Location Based Garbage Management System</a>, All Right Reserved.
                    </div>
